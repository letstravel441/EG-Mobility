 ...
 */
class bike_oilchangeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_bike_oilchange, container, false)
        var recyclerView = view.findViewById(R.id.stations8) as RecyclerView
...
class UserItem8(val u:Busi_user): Item<GroupieViewHolder>(){
