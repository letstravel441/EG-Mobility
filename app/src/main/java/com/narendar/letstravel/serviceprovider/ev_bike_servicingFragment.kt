 ...
 */
class ev_bike_servicingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_ev_bike_servicing, container, false)
        var recyclerView = view.findViewById(R.id.stations15) as RecyclerView
...
class UserItem15(val u:Busi_user): Item<GroupieViewHolder>(){
