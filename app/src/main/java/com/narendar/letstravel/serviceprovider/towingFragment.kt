...
class towingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_towing, container, false)
        var recyclerView = view.findViewById(R.id.stations2) as RecyclerView
...
class UserItem2(val u:Busi_user): Item<GroupieViewHolder>(){
