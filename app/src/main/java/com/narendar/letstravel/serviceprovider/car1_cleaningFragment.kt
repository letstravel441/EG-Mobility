 ...
 */
class car1_cleaningFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_car1_cleaning, container, false)
        var recyclerView = view.findViewById(R.id.stations20) as RecyclerView
...
class UserItem20(val u:Busi_user): Item<GroupieViewHolder>(){
