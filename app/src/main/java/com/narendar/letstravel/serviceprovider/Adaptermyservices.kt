        ...
        holder.deny.setOnClickListener(View.OnClickListener {
            ...
            builder.setPositiveButton(
                ...
                try {
                    ...
                    notificationObj.put("body", "Your request has been denied by the service provider")
                ...
                db.collection("service_user").whereEqualTo("serviceproviderid", sp_services.serviceproviderid).whereEqualTo("userid",sp_services.userid).whereEqualTo("type",sp_services.type).whereEqualTo("nameservice",sp_services.nameservice)
                            ...
                            if (value != null) {
                                for (i in value) {
                                    FirebaseFirestore.getInstance().collection("service_user")
                                        .document(i.id)
                                        .update("message", "Service request is Cancelled By Service Provider")
                                }
        ...
        holder.accept.setOnClickListener(View.OnClickListener {
            ...
            builder.setPositiveButton(
                ...
                try {
                    ...
                    val notificationObj = JSONObject()
                    notificationObj.put("title", "Service Provider")
                    notificationObj.put("body", "Your request is accepted by the service provider")
                    val extraData = JSONObject()
                    extraData.put("user_name", "adcd")
                    extraData.put("pn_num", "xxxxxx")
                    extraData.put("service","car_breakdown")
