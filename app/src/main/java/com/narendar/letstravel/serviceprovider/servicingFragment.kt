 ...
 */
class servicingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_servicing, container, false)
        var recyclerView = view.findViewById(R.id.stations1) as RecyclerView
...
class UserItem1(val u:Busi_user): Item<GroupieViewHolder>(){
