 ...
 */
class car1_tyrepunctureFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_car1_tyrepuncture, container, false)
        var recyclerView = view.findViewById(R.id.stations23) as RecyclerView
...
class UserItem23(val u:Busi_user): Item<GroupieViewHolder>(){
