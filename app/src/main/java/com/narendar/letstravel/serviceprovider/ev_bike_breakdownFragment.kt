 ...
 */
class ev_bike_breakdownFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_ev_bike_breakdown, container, false)
        var recyclerView = view.findViewById(R.id.stations12) as RecyclerView
...
class UserItem12(val u:Busi_user): Item<GroupieViewHolder>(){
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        viewHolder.itemView.setOnClickListener(View.OnClickListener { v ->
            ...
            intent.putExtra("linkservice","Breakdown")
