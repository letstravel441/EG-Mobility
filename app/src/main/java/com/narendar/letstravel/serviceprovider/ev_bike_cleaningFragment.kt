 ...
 */
class ev_bike_cleaningFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_ev_bike_cleaning, container, false)
        var recyclerView = view.findViewById(R.id.stations14) as RecyclerView
...
class UserItem14(val u:Busi_user): Item<GroupieViewHolder>(){
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        viewHolder.itemView.setOnClickListener(View.OnClickListener { v ->
            ...
            intent.putExtra("linkservice","cleaning")
