 ...
 */
class car1_breakdownFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_car1_breakdown, container, false)
        var recyclerView = view.findViewById(R.id.stations18) as RecyclerView
...
class UserItem18(val u:Busi_user): Item<GroupieViewHolder>(){
