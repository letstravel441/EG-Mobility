 ...
 */
class bike_cleaningFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_bike_cleaning, container, false)
        var recyclerView = view.findViewById(R.id.stations7) as RecyclerView
...
class UserItem7(val u:Busi_user): Item<GroupieViewHolder>(){
