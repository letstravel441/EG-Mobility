...
class cleaningFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_cleaning, container, false)
        var recyclerView = view.findViewById(R.id.stations3) as RecyclerView
...
class UserItem3(val u:Busi_user): Item<GroupieViewHolder>(){
