 ...
 */
class car1_towingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_car1_towing, container, false)
        var recyclerView = view.findViewById(R.id.stations22) as RecyclerView
...
class UserItem22(val u:Busi_user): Item<GroupieViewHolder>(){
