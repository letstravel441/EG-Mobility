 ...
 */
class bike_towingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_bike_towing, container, false)
        var recyclerView = view.findViewById(R.id.stations10) as RecyclerView
...
class UserItem10(val u:Busi_user): Item<GroupieViewHolder>(){
