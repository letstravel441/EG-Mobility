 ...
 */
class bike_breakdownFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_bike_breakdown, container, false)
        var recyclerView = view.findViewById(R.id.stations6) as RecyclerView
...
class UserItem6(val u:Busi_user): Item<GroupieViewHolder>(){
