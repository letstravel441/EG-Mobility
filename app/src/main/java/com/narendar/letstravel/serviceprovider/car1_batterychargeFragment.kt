 ...
 */
class car1_batterychargeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_car1_batterycharge, container, false)
        var recyclerView = view.findViewById(R.id.stations19) as RecyclerView
...
class UserItem19(val u:Busi_user): Item<GroupieViewHolder>(){
