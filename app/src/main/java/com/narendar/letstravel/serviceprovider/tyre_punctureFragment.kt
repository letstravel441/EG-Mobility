 ...
 */
class tyre_punctureFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_tyre_puncture, container, false)
        var recyclerView = view.findViewById(R.id.stations5) as RecyclerView
...
class UserItem5(val u:Busi_user): Item<GroupieViewHolder>(){
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        viewHolder.itemView.setOnClickListener(View.OnClickListener { v ->
            ...
            intent.putExtra("linkservice","tyre_puncture")
