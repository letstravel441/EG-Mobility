 ...
 */
class ev_bike_tyre_punctureFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_ev_bike_tyre_puncture, container, false)
        var recyclerView = view.findViewById(R.id.stations17) as RecyclerView
...
class UserItem17(val u:Busi_user): Item<GroupieViewHolder>(){
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        viewHolder.itemView.setOnClickListener(View.OnClickListener { v ->
            ...
            intent.putExtra("linkservice","tyre puncture")
